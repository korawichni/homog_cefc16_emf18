...
mgeo = "{Geometrical parameters/";
mfem = "{Analysis parameters/";
...
DefineConstant[
  Flag_HomogenisedModel = {0, Choices{
      0="Fine reference", 1="Homogenized"}, Name StrCat[mfem,"000Model"], Highlight Str[col2] }
...
DefineConstant[
  MD = {1,  Name StrCat[ mgeo,"01Mesh density in winding window"], Highlight Str[col1]}
  Flag_HalfModel = {1,  Choices{0,1},  Name StrCat[ mgeo,"00Symmetry"], Highlight Str[col1], Closed 1}
  NbrLayersX = {1,  Min 1, Max 6, Name StrCat[ mgeo,"10Number of layers X"], Highlight Str[col3]} //6 
  NbrLayersY = {2, Min 2, Max 20, Step 2, Name StrCat[ mgeo,"11Number of layers Y"], //20 even number
